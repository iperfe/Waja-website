      ...
      <div class="flex flex-col md:flex-row justify-between items-center gap-2">
        ...
        <div class="flex items-center gap-4">
          ...
          <div class="flex gap-2">
            <a href="#" class="w-6 h-6 bg-blue-800 rounded-full flex items-center justify-center hover:bg-blue-700 transition-colors duration-300 transform hover:scale-110">
    ...
    <div class="max-w-7xl mx-auto px-4">
      <div class="flex items-center justify-between h-20">
        ...
        <a href="{{ route('home') }}" class="flex items-center gap-3 group">
          <div class="h-12 w-12 bg-gradient-to-br from-blue-600 to-blue-800 rounded-lg flex items-center justify-center text-white font-bold text-xl transform group-hover:scale-105 transition-transform duration-300">
            W
          </div>
          <div>
        ...
        <div class="grid lg:grid-cols-4 md:grid-cols-2 gap-8">
          ...
          <div class="lg:col-span-2">
            <div class="flex items-center gap-3 mb-6 group">
              <div class="h-12 w-12 bg-gradient-to-br from-blue-600 to-blue-800 rounded-lg flex items-center justify-center text-white font-bold text-xl group-hover:scale-110 transition-transform duration-300">
                W
              </div>
              <div>

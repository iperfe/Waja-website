    ...
    <div class="max-w-7xl mx-auto px-4 py-2">
      <div class="flex flex-col md:flex-row justify-between items-center gap-2">
        ...
        <div class="flex items-center gap-4">
          <span class="text-blue-200">Mon-Fri: 8AM-6PM</span>
          <div class="flex gap-2">
            <a href="#" class="w-6 h-6 bg-blue-800 rounded-full flex items-center justify-center hover:bg-blue-700 transition-colors duration-300">
      ...
      <div class="grid md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul class="space-y-3">
            ...
            <li><a href="{{ route('products') }}" class="text-gray-300 hover:text-white transition-colors duration-300">Our Services</a></li>
